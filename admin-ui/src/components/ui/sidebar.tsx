  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={twMerge(
          "fixed inset-y-0 z-10 hidden w-(--sidebar-width) bg-bg",
      ...
      className={composeRenderProps(
        ...
        (className, { isPressed, isFocusVisible, isHovered, isDisabled }) =>
          twMerge([
            ...
            isCurrent &&
              "font-medium text-sidebar-primary hover:bg-(--sidebar-current-bg)/20 hover:text-(--sidebar-primary) **:data-[slot=icon]:text-(--sidebar-primary)! hover:**:data-[slot=icon]:text-(--sidebar-primary)! [&_.text-muted-fg]:text-fg/80",
            isFocusVisible &&
              "inset-ring inset-ring-sidebar-ring outline-hidden",
            (isPressed || isHovered) &&
              "bg-sidebar-accent/50 text-sidebar-accent-fg **:data-[slot=icon]:text-text-sidebar-accent-fg",
